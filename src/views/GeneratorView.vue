  ...
  <div class="min-h-screen px-4 py-6">
    ...
    <div class="generatorAll max-w-2xl mx-auto p-4 sm:p-8">
      <div class="bg-white/10 rounded-2xl p-4 sm:p-8 shadow-2xl border border-light-grass/40">
        ...
        <!-- RESULTAT VISNING: Vises kun når der er valgt en opgave -->
        <div v-if="randomTask" class="result-container bg-white/20 rounded-xl p-4 sm:p-6 border border-light-grass/30">
          <div class="text-center">
            ...
            <!-- OPGAVE TITEL: Den tilfældige opgave der blev valgt -->
            ...
            <!-- KATEGORI TAG: Viser hvilken type opgave det er -->
        ...
        <!-- TOM TILSTAND: Vises når ingen opgave er valgt endnu -->
        ...
        <!-- STATISTIK: Viser hvor mange opgaver der er tilgængelige -->
...
// AUTOMATISK INDLÆSNING: Hent opgaver når siden starter
onMounted(() => {
  fetchTasks()
})
...
const generateRandomTask = () => {
  // SIKKERHEDSTJEK: Er der overhovedet nogle opgaver?
  if (tasks.value.length > 0) {

    // TILFÆLDIGHEDSGENERATOR: Vælg et tal mellem 0 og antal opgaver
    // Math.random() giver tal mellem 0-1
    // Math.floor() runder ned til nærmeste hele tal
    const randomIndex = Math.floor(Math.random() * tasks.value.length)

    // GEM DEN VALGTE OPGAVE: Brug det tilfældige tal som index
